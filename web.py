...
st.markdown("""
    ...
    .neon-panel { border: 2px solid #DC143C; border-radius: 12px; background: #050505; margin-bottom: 20px; box-shadow: 0 0 15px rgba(220, 20, 60, 0.2); height: 160px; }
...
if df_1m is not None and df_15m is not None:
    ...
    # --- DASHBOARD (ALTURA FIJA PARA SIMETRÍA) ---
        ...
        st.markdown(f'''
            <div class="neon-panel">
                ...
                <div class="panel-content">
                    ...
                    <div style="font-size:11px; color:{radar_col}; font-weight:bold; margin-top:5px;">Radar 15m: {radar_txt}</div>
                </div>
    ...
    # --- LÓGICA DE COMPRA (ABEJA VALIENTE) ---
