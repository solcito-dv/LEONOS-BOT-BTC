...
st.markdown("""
    ...
    .neon-panel { border: 2px solid #DC143C; border-radius: 12px; background: #050505; margin-bottom: 15px; box-shadow: 0 0 15px rgba(220, 20, 60, 0.1); height: 100%; display: flex; flex-direction: column; }
